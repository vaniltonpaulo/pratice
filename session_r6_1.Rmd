...
Running this code should confirm that the `area` updates whenever either `width` or `height` is changed. Attempting to do `rect$area <- 100` should result in an error.
...
Negative balances should be prohibited:
Reducing the balance to a negative amount should throw an error before the class is changed.
