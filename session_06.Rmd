...
```{r}
pattern.word.surrounded <- ".*"  # change this?
```
...
```{r}
pattern.logical.vect <- ".*"  # change this?
```
...
```{r}
author.pattern <- ".*"  # change this?
author.replacement <- "x"  # change this?
```
